...
#pragma region constructor - destructor
	...
	//copy constructor
	//MA #1 TODO: Implement!
	//Q: What is the relationship of the number of computational
	//	 statements and our input variabls?
	//O(N)
	LinkedList(const LinkedList<T> &other)
	{
		if (this != &other) //don't copy ourself
		{
			//O(N)
	...
	LinkedList(LinkedList<T> &&other)
	{
		...
		_las_accessed_node = other._last_accessed_node;
		_size = other._size;
